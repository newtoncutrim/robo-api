...
class RobotRequest extends FormRequest
{
    ...
    {
        return [
            'left_elbow_id' => ['nullable', 'integer', 'between:1,4'],
            'right_elbow_id' => ['nullable', 'integer', 'between:1,4'],
            'left_wrist_id' => ['nullable', 'integer', 'between:1,7'],
            'right_wrist_id' => ['nullable', 'integer', 'between:1,7'],
            'head_rotation_id' => ['nullable', 'integer', 'between:1,5'],
    ...
    public function messages(): array
    {
        return [
            ...
            'left_elbow_id.between' => 'O valor do campo "Cotovelo Esquerdo" deve estar entre 1 e 4.',
            ...
            'right_elbow_id.between' => 'O valor do campo "Cotovelo Direito" deve estar entre 1 e 4.',
            ...
            'left_wrist_id.between' => 'O valor do campo "Pulso Esquerdo" deve estar entre 1 e 7.',
            ...
            'right_wrist_id.between' => 'O valor do campo "Pulso Direito" deve estar entre 1 e 7.',
            ...
            'head_rotation_id.between' => 'O valor do campo "Rotação da Cabeça" deve estar entre 1 e 5.',
